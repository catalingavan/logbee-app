...
[logbee.Frontend-v2.0.0](https://github.com/catalingavan/logbee-app/releases/tag/logbee.Frontend-v2.0.0)

[logbee.Backend-v2.0.1](https://github.com/catalingavan/logbee-app/releases/tag/logbee.Backend-v2.0.1)

```none
docker pull catalingavan/logbee.frontend:2.0.0
docker pull catalingavan/logbee.backend:2.0.1
```
