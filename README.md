...
[logbee.Frontend-v1.3.2](https://github.com/catalingavan/logbee-app/releases/tag/logbee.Frontend-v1.3.2)

[logbee.Backend-v1.3.0](https://github.com/catalingavan/logbee-app/releases/tag/logbee.Backend-v1.3.0)

```none
docker pull catalingavan/logbee.frontend:1.3.2
