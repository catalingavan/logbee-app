# [![Logbee](https://github.com/user-attachments/assets/10d26fb9-d0e8-452a-9bef-90579b246d94)](https://logbee.net)
...
[logbee.Frontend-v2.2.1](https://github.com/catalingavan/logbee-app/releases/tag/logbee.Frontend-v2.2.1)

[logbee.Backend-v2.2.0](https://github.com/catalingavan/logbee-app/releases/tag/logbee.Backend-v2.2.0)

```none
docker pull catalingavan/logbee.frontend:2.2.1
docker pull catalingavan/logbee.backend:2.2.0
```
